...
public class ConfigOptions {
        ...
        public static class ListConfigOptionBuilder<E> {
            ...
            public final ConfigOption<List<E>> defaultValues(E... values) {
                return new ConfigOption<>(
                        key, clazz, ConfigOption.EMPTY_DESCRIPTION, Arrays.asList(values), true, false);
            }
            ...
            public ConfigOption<List<E>> noDefaultValue() {
                return new ConfigOption<>(key, clazz, ConfigOption.EMPTY_DESCRIPTION, null, true, false);
            }
        }
    }
    ...
    public static class TypedConfigOptionBuilder<T> {
         ...
         */
        public OptionBuilder.ListConfigOptionBuilder<T> asList() {
            return new OptionBuilder.ListConfigOptionBuilder<>(key, clazz);
        }
        ...
        public ConfigOption<T> defaultValue(T value) {
            return new ConfigOption<>(key, clazz, ConfigOption.EMPTY_DESCRIPTION, value, false, false);
        }
        ...
        public ConfigOption<T> noDefaultValue() {
            return new ConfigOption<>(
                    key, clazz, ConfigOption.EMPTY_DESCRIPTION, null, false, false);
        }
         ...
         * @return The config option without a default value.
         */
        public ConfigOption<T> notNull() {
            return new ConfigOption<>(
                    key, clazz, ConfigOption.EMPTY_DESCRIPTION, null, false, true);
        }
    }
